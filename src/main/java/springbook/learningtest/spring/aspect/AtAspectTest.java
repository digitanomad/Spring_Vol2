...
//		private void returnString() {}
		@Pointcut("@args(springbook.learningtest.spring.aspect.AtAspectTest.Anno)")
		private void returnString() {}
		@Pointcut("within(springbook.*)")
		private void helloClass() {}
		@Pointcut("returnString() || helloClass()")
		private void combine() {}
		@Pointcut("returnString() && args(String)")
		private void common() {}
		
		@Before("returnString()")
		public void callLogReturnString(JoinPoint jp) {

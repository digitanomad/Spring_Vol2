...
public class AtAspectTest2 {
	...
	public void simple() {
		...
		ac.register(HelloBean.class, HiBean.class, SimpleMonitoringAspect.class);
	...
	@Aspect
	public static class SimpleMonitoringAspect {
		@Pointcut("this(springbook.learningtest.spring.aspect.AtAspectTest2.HelloBean)")

...
import springbook.learningtest.spring.ioc.scanner.dao.MyDao;
import springbook.learningtest.spring.ioc.scanner.service.MyService;
import springbook.learningtest.spring.ioc.scanner.service.ServiceMarker;
...
public class JavaCodeBeanDefinitionTest {
	...
	@Configuration
	@ComponentScan(basePackages={"springbook.learningtest.spring.ioc.scanner"},
	...
	@Configuration
	@ImportResource("springbook/learningtest/spring/ioc/extra.xml")

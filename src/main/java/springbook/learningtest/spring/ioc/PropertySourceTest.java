...
public class PropertySourceTest {
	...
	@Configuration
	@ImportResource("springbook/learningtest/spring/ioc/appconfig2.xml")
	@org.springframework.context.annotation.PropertySource(name = "DB Settings", value={"springbook/learningtest/spring/ioc/appconfig2.properties"})

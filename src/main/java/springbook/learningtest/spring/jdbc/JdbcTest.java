...
public class JdbcTest {
	...
	@BeforeClass
	public static void init() throws SQLException, IllegalStateException, NamingException {
		SimpleNamingContextBuilder builder = new SimpleNamingContextBuilder();
		SimpleDriverDataSource ds = new SimpleDriverDataSource(new com.mysql.jdbc.Driver(), "jdbc:mysql://localhost/springbook?characterEncoding=UTF-8", "root", "digita913");
	...
	static class SimpleDao {
		...
		public DataSource dataSource() {
			try {
				return new SimpleDriverDataSource(new com.mysql.jdbc.Driver(), "jdbc:mysql://localhost/springbook?characterEncoding=UTF-8", "root", "digita913");

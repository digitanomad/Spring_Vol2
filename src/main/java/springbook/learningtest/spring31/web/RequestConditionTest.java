...
public class RequestConditionTest extends AbstractDispatcherServletTest {
	...
	public void patternRc() throws ServletException, IOException {
		setClasses(AppConfig.class, PatternController.class, ParamsController.class, RequestMethodController.class,
				HeadersController.class, ConsumesController.class, ProducesController.class, Quiz4.class, Quiz5.class, Quiz6.class);
	...
	static class Quiz6 {
		@RequestMapping(consumes={"application/json", "multipart/form-data"})
		public void hello() {
		}
	}
}
